        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <div class="section-heading">
                    <h2>La manera más rápida de encontrar tu plaza de aparcamiento</h2>
                    <p class="text-muted">¡Mira lo que podrás hacer con nuestra aplicación!</p>
                    <hr>
                </div>
            </div>
        </div>
...
<section id="contact" class="contact bg-primary">
    <div class="container">
        <h2>¡Compártelo con tus compañeros!</h2>
        <ul class="list-inline list-social">
            <li class="social-twitter">
                <a><i style="margin-top:20px;" class="fa fa-twitter"></i></a>
            </li>
            <li class="social-facebook">
                <a><i style="margin-top:20px;" class="fa fa-facebook"></i></a>
            </li>
            <li class="social-google-plus">
                <a><i style="margin-top:20px;" class="fa fa-google-plus"></i></a>
            </li>
        </ul>
    </div>
</section>
...
<footer>
    <div class="container">
        <p>© 2017 Apar-K. Todos los derechos reservados.</p>
